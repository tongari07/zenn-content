...
弊社のテックイベント [Money Forward TECH DAY'24](https://techday.moneyforward-dev.jp/2024/#main) にて同じチームの [Taiga Kiyokawa](https://zenn.dev/taigakiyokawa) さんが発表した[Money Forward UIの紹介](https://techday.moneyforward-dev.jp/2024/sessions/talk-04/)をご覧ください。
